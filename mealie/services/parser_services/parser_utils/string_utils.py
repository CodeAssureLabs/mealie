...
def extract_quantity_from_string(source_str: str, default_quantity: float = 0.0) -> tuple[float, str]:
    """
    ...
    # If no match, return the fallback quantity and the original string
    return default_quantity, source_str
