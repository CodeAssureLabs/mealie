...
from mealie.services.event_bus_service.event_types import EventOperation, EventShoppingListData, EventTypes
...
class ShoppingListItemController(BaseCrudController):
    ...
    def create_many(self, data: list[ShoppingListItemCreate]):
        ...
        ShoppingListEventService(self.publish_event).publish_collection(items)
        return items
